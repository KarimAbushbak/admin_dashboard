...
class ManagerColors {
  ...
  static const Color magedHome = Color(0xffdcc799);
  ...
  static const Color bgColorTextField = Color(0xffEDEDED);
  static const Color bgBorderColorTextField = Color(0xffB2B2B2);
